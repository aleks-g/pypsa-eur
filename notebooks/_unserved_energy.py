...
if __name__ == "__main__":
    ...
    for year in years:
        for op_year in years:
            if year != op_year:
                loadshedding = pd.read_csv(f"../results/{config_name}/weather_year_{year}/validation/weather_year_{op_year}_base_s_90_elec_lc1.0_Co2L0.0.csv", index_col=0, parse_dates=True)
