...
def collect_annual_values(
    ...
    if "Prevents deficits" in ranked_years.columns:
        annual_values["design_year"] = ranked_years["Prevents deficits"]
    else:
        annual_values["design_year"] = ranked_years["Design year"]
    if "Prevents peaks" in ranked_years.columns:
        annual_values["op_year"] = ranked_years["Prevents peaks"]
    else:
        annual_values["op_year"] = ranked_years["Operational year"]
