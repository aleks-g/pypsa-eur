...
if __name__ == "__main__":
    ...
    for design_year in years:
        ...
        os.makedirs(
            f"./load_shedding/{config_name}/design_years/{design_year}/", exist_ok=True
        )
        nodal_shedding.to_csv(
            f"./load_shedding/{config_name}/design_years/{design_year}/nodal_shedding.csv"
        )
        system_shedding.to_csv(
            f"./load_shedding/{config_name}/design_years/{design_year}/system_shedding.csv"
        )
        mean_shedding.to_csv(
            f"./load_shedding/{config_name}/design_years/{design_year}/mean_nodal_shedding.csv"
        )
        mean_system_shedding.to_csv(
            f"./load_shedding/{config_name}/design_years/{design_year}/mean_system_shedding.csv"
        )
        max_shedding.to_csv(
            f"./load_shedding/{config_name}/design_years/{design_year}/max_shedding.csv"
        )
        expected_shedding.to_csv(
            f"./load_shedding/{config_name}/design_years/{design_year}/expected_shedding.csv"
        )
