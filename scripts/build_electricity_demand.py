...
def manual_adjustment(load, fn_load, countries):
    ...
    # ============================================================================
    # OLD MANUAL COUNTRY ADJUSTMENTS (commented out - kept for reference)
    # These were replaced by template year approach (see main section below)
    # To re-enable: uncomment these lines and comment out the template year code
    # ============================================================================
    # if "AL" not in load and "AL" in countries:
    #     if "ME" in load:
    #         load["AL"] = load.ME * (5.7 / 2.9)  # Scale from Montenegro
    #     elif "MK" in load:
    #         load["AL"] = load["MK"] * (4.1 / 7.4)  # Scale from North Macedonia
    #
    # if "MK" in countries and "MK" in countries:
    #     if "MK" not in load or load.MK.isnull().sum() > len(load) / 2:
    #         if "ME" in load:
    #             load["MK"] = load.ME * (6.7 / 2.9)  # Scale from Montenegro
    #
    # if "BA" not in load and "BA" in countries:
    #     if "ME" in load:
    #         load["BA"] = load.HR * (11.0 / 16.2)  # Scale from Croatia
    #
    # if "XK" not in load and "XK" in countries:
    #     if "RS" in load:
    #         load["XK"] = load["RS"] * (4.8 / 27.0)  # Scale from Serbia
    # ============================================================================

    # ============================================================================
    # OLD TIMESLICE COPIES (commented out - kept for reference)
    # Some of these differ from upstream v2026.02.0
    # ============================================================================
    ...
    # # MK specific hourly adjustments
...
if __name__ == "__main__":
    ...
    # ============================================================================
    # OLD UA/MD HANDLING (commented out - kept for reference)
    # ============================================================================
    # if "UA" in countries:
